...
@Component({
  selector: 'app-top-profit-items',
  standalone: true,
  imports: [],
  templateUrl: './top-profit-items.component.html',
  styleUrl: './top-profit-items.component.scss'
})
export class TopProfitItemsComponent {
...
ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetTopProfitItemsBySeller(userId).subscribe( {
      next:(res)=>{
