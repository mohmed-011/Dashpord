...
@Component({
  selector: 'app-unsold-product-report',
  standalone: true,
  imports: [],
  templateUrl: './unsold-product-report.component.html',
  styleUrl: './unsold-product-report.component.scss'
})
export class UnsoldProductReportComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetUnsoldItemsBySeller(userId).subscribe( {
      next:(res)=>{
