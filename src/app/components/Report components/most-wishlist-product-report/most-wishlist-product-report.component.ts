...
@Component({
  selector: 'app-most-wishlist-product-report',
  standalone: true,
  imports: [],
  templateUrl: './most-wishlist-product-report.component.html',
  styleUrl: './most-wishlist-product-report.component.scss'
})
export class MostWishlistProductReportComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetTopWishlistedItemsBySeller(userId).subscribe( {
      next:(res)=>{
