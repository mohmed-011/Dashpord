...
@Component({
  selector: 'app-most-top-viewers-report',
  standalone: true,
  imports: [],
  templateUrl: './most-top-viewers-report.component.html',
  styleUrl: './most-top-viewers-report.component.scss'
})
export class MostTopViewersReportComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetTopViewersBySeller(userId).subscribe( {
      next:(res)=>{
