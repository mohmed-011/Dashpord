...
@Component({
  selector: 'app-out-of-stok-product-report',
  standalone: true,
  imports: [],
  templateUrl: './out-of-stok-product-report.component.html',
  styleUrl: './out-of-stok-product-report.component.scss'
})
export class OutOfStokProductReportComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetDiscountedItemsBySeller(userId).subscribe( {
      next:(res)=>{
