...
@Component({
  selector: 'app-most-viwed-product-report',
  standalone: true,
  imports: [],
  templateUrl: './most-viwed-product-report.component.html',
  styleUrl: './most-viwed-product-report.component.scss'
})
export class MostViwedProductReportComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetMostViewedProductsBySeller(userId).subscribe( {
      next:(res)=>{
