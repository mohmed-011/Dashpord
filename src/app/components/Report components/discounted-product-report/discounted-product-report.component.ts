...
@Component({
  selector: 'app-discounted-product-report',
  standalone: true,
  imports: [],
  templateUrl: './discounted-product-report.component.html',
  styleUrl: './discounted-product-report.component.scss'
})
export class DiscountedProductReportComponent {
