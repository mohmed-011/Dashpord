...
@Component({
  selector: 'app-most-sold-product-report',
  standalone: true,
  imports: [],
  templateUrl: './most-sold-product-report.component.html',
  styleUrl: './most-sold-product-report.component.scss'
})
export class MostSoldProductReportComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.GetTopSoldItemsBySeller(userId).subscribe( {
      next:(res)=>{
        this.dailyData = res
