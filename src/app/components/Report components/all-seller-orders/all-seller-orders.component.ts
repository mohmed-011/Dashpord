...
@Component({
  selector: 'app-all-seller-orders',
  standalone: true,
  imports: [],
  templateUrl: './all-seller-orders.component.html',
  styleUrl: './all-seller-orders.component.scss'
})
export class AllSellerOrdersComponent {
...
// ordersChart!: Chart;
  ...
  ngAfterViewInit(): void {
    ...
    this.reportsService.getAllOrdersReport(userId).subscribe( {
      next:(res)=>{
